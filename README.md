...
```
python main_9.py --partition iid
python main_9.py --partition dir --beta 0.05
python main_9.py --partition noniid --label_num_per_client 4
```

Combine any of the above:
```
python main_9.py --dataset svhn --num_client 20 --partition dir --beta 0.05
```
